...
HepMC::GenEvent * make_simple_tau_event(double tau_energy){
  ...
  */
  ...
  //make polarization
  HepMC::ThreeVector pol(0,0,-1);
  HepMC::Polarization pol_tau1(pol);
  //set polarization
  tau1->set_polarization(pol            _tau1);
    
  //create auxiliary particles
  //  HepMC::GenParticle * neu1 = new HepMC::GenParticle(
