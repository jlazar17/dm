...
# in neutrinocommon linked
#rel_dir = "/Users/carguelles/Programs/neutrinocommons/neutrinocommon/linked/"
rel_dir = "../../../linked/"
...
HepMCinc = rel_dir+"hepmc/src/HepMC"
...
PYTHIALIBS = "pythia8","hepmcinterface","lhapdfdummy"

ext_modules = [Extension("taudecay", ["taudecay.pyx"],language="c++",include_dirs=[HepMCinc,TAUOLAinc],libraries=["HepMC","TauolaCxxInterface"],extra_link_args=["-fPIC","-rdynamic","-L"+TAUOLAlib,"-L"+HepMClib])]
