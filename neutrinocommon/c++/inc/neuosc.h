...
//#define NoOscMatterEffect
//#define Include_NewPhysics

//#define NewPhysics_DEBUG
...
gsl_matrix_complex* massAcc(PhysConst*,double,Body*,Track*,gsl_matrix_complex*);

gsl_matrix_complex* flavorH(PhysConst*,double,Body*,Track*,gsl_matrix_complex*);
gsl_matrix_complex* massH(PhysConst*,double,Body*,Track*,gsl_matrix_complex*,gsl_matrix_complex*);
// evolution operators
gsl_matrix_complex* massExpH0(PhysConst*,double E,Track*,gsl_matrix_complex*);
