...
double TauPolarization = -1.0;

double RPion = SQR(0.07856),RRho = SQR(0.43335),RA1 = SQR(0.70913);

double BrLepton = 0.18,BrPion = 0.12,BrRho = 0.26,BrRA1 = 0.13,BrHadron = 0.13;
...
double TauDecayToPion(double E_tau,double E_nu){
    double z = E_nu/E_tau;
...
double TauDecayToRho(double E_tau,double E_nu){
    double z = E_nu/E_tau;
...
double TauDecayToA1(double E_tau,double E_nu){
    double z = E_nu/E_tau;
...
double TauDecayToHadron(double E_tau,double E_nu){
    double z = E_nu/E_tau;
