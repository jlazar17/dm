...
def DMSunAnnihilationRate(DM_mass,DM_cs,param):
    ...
    return DMSunAnnihilationJungman(DM_mass,DM_cs,param)
...
def DMSunAnnihilationJungman(DM_mass,DM_cs,param):
    ...
    C_c = (4.8e22*param.sec**-1)*(DM_rho/(0.3*param.GeV/param.cm**3))*((270*param.km*param.sec**-1)/vel_local)*(100.0*param.GeV/DM_mass)*(DM_cs/(1.0e-40*param.cm**2))*sum(nuclear_term)
